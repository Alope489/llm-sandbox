...
| --- | --- | --- | --- |
| ask_elapsed_ms_mean (ms) | 25253.1 | 42120.0 | +16866.9 |
| ask_input_tokens_mean | 7892 | 16770 | +8877 |
| ask_aggregate_throughput (tok/s) | 22.4 | 14.8 | -7.6 |
| preload_elapsed_ms | 7310.6 | 69740.4 | +62429.9 |

## Citation miss count

- Total across all steps: `59` (not excluded from the unfiltered metrics above; responses without file_citation are flagged only).
